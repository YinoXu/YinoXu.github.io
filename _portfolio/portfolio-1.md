...
excerpt: "Use functions provide a convenient and effective way to load, process, and analyze data for machine learning purposes.<br/><img src='/images/ml.png'>"
collection: portfolio
---

# FingeripsPositionEstimationofaRobotHand-
This is my final project for my machine learning class
Check the [github](https://github.com/YinoXu/FingeripsPositionEstimationofaRobotHand-) for more details.
